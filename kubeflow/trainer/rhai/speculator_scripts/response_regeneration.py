...
def parse_args():
    ...
    parser.add_argument(
        "--subset",
        default=None,
        help=("Dataset subset/config name (auto-detected from dataset config if not specified)"),
    )
...
async def main():
    ...
    connector = aiohttp.TCPConnector(limit=None, force_close=False, enable_cleanup_closed=True)
    headers = {
