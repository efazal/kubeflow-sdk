...
# Speculator training constants
SPECULATOR_SIDECAR_NAME = "vllm-sidecar"
SPECULATOR_SIDECAR_PORT = 8234
SPECULATOR_SIDECAR_HEALTH_URL = f"http://localhost:{SPECULATOR_SIDECAR_PORT}/health"
SPECULATOR_SIDECAR_ENDPOINT = f"http://localhost:{SPECULATOR_SIDECAR_PORT}/v1"
SPECULATOR_ENV_VERIFIER_MODEL = "SPECULATOR_VERIFIER_MODEL"
SPECULATOR_ENV_HS_PATH = "SPECULATOR_HS_PATH"
SPECULATOR_HIDDEN_STATES_SUBDIR = "data/hidden_states"
SPECULATOR_DATA_SUBDIR = "data"
SPECULATOR_EXTRACTION_SCRIPT = "data_generation_offline.py"
SPECULATOR_RESPONSE_GEN_SCRIPT = "response_regeneration.py"
SPECULATOR_SCRIPTS_DIR = "speculator_scripts"
